...
const PATHS: Record<IconName, string> = {
  ...
  'headphones-off': 'M4.5 16v-3a7.5 7.5 0 0 1 12.6-5.5M19.5 13v3M4.5 15.5h2a1 1 0 0 1 1 1v2.5a1 1 0 0 1-1 1h-1a1 1 0 0 1-1-1zM19.5 15.5h-2a1 1 0 0 0-1 1v2.5a1 1 0 0 0 1 1h1a1 1 0 0 0 1-1zM4 4l16 16',
