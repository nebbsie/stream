...
try {
  const raw = await page.evaluate(async () => {
    ...
    // A low pitch with harmonics above it, the part of speech this network keys on, at the level of the noise.
  ...
  const live = await page.evaluate(async () => {
    ...
    // Let the recurrent state settle, then average: one read of a moving signal is a reading of the moment.
  ...
  // A loose bound on purpose: runs land a fifth to two fifths quieter; the strength is measured frame by frame above.
  check(
